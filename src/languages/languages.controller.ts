...
export class LanguagesController {
  ...
  async create(@Body() createLanguageDto: CreateLanguageDto) {
    ...
    const isLanguageExists = await this.languagesService.findOneByName(
  ...
  async update(
    ...
    const isNewLanguageExistsByName = await this.languagesService.findOneByName(
    ...
    const updatedLanguage = await this.languagesService.update(
      +id,
      updateLanguageDto,
    );
    return {
